...
CREATE TABLE fb_comments_count(created_at DATE, number_of_comments BIGINT, user_id BIGINT);
CREATE TABLE fb_active_users(country VARCHAR, name VARCHAR, status VARCHAR, user_id BIGINT);
